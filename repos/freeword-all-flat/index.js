...
export const Wordforms = Object.fromEntries(WordformsAllFlat.map(
  ([word, core, pos, stemkind, suffix, stemcore, stemsplit, freq, wordbits, gloss]) => (
  [word, { word, core, pos, stemkind, suffix, stemcore, stemsplit, freq, wordbits, gloss }]
)))
export default Wordforms

/** @type {readonly TY.Poskind[]} */
export const Poskinds     = [
  'adj', 'adv', 'verb', 'noun', 'intj', 'prep', 'conj', 'pron', 'art',
] // as const

/** @type {Record<TY.Poskind, readonly TY.Stemkind[]>} */
